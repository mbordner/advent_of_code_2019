...
import (
	"github.com/mbordner/advent_of_code_2019/day18/part1"
	"github.com/mbordner/advent_of_code_2019/day18/part2"
	"bufio"
	"log"
	"os"
)
...
func main() {
	...
	g1 := part1.NewGame(chars)
	g1.Execute()

	g2 := part2.NewGame(chars)
	g2.Execute()
