...
instructions:
	for i < len(program) {
		if length, ok := opCodes[program[i]%100]; ok {
			...
			case 4:
				fmt.Println("output: ", program[params[0]])
			case 5:
